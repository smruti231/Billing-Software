...
class CatClass:
    def __init__(self, root):
        ...
        cat_frame=Frame(self.root, bd=3,relief=RIDGE)   #relief style ke liye realwidth taki size window ke hisab se lele
        cat_frame.place(x=680,y=100,width=380,height=100)

        scrolly=Scrollbar(cat_frame,orient=VERTICAL)
        scrollx=Scrollbar(cat_frame,orient=HORIZONTAL)

        self.category_table=ttk.Treeview(cat_frame,columns=("cid","name"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set) #tupple banaye hai
