...
class PrdClass:
    def __init__(self,root,productFrame=None):
        ...
        cmb_cat.place(x=150,y=75,width=200)
        cmb_cat.current(0)
        ...
        cmb_sup.place(x=150,y=125,width=200)
        cmb_sup.current(0)

        txt_name=Entry(product_Frame,textvariable=self.var_name,font=("goudy old style",15),bg='seashell2').place(x=150,y=175,width=200)
        txt_price=Entry(product_Frame,textvariable=self.var_price,font=("goudy old style",15),bg='seashell2').place(x=150,y=225,width=200)
        txt_qty=Entry(product_Frame,textvariable=self.var_qty,font=("goudy old style",15),bg='seashell2').place(x=150,y=275,width=200)

        cmb_status=ttk.Combobox(product_Frame,textvariable=self.var_status,values=("Active","Inactive"),state='readonly',justify=CENTER,font=("goudy old style", 15))
        cmb_status.place(x=150,y=325,width=200)
...
#===Product details=====
        ...
        p_frame = Frame(self.root, bd=3,relief=RIDGE)   #relief style ke liye realwidth taki size window ke hisab se lele
     ...
     #================================================================== #self isliye kyuki sabse upar self use kiya ha widgets mai call kiya hai fun mai bhi use karna hai isliye
